        ...
        <div class="row">
          <div class="col">
            <div class="box_section">
              ...
              <div class="buy_bt_1 active"><a href="prod1">Buy Now</a></div>
            </div>
          </div>
          <div class="col">
            <div class="box_section">
              ...
              <h2 class="dolor_text_1">1 kg</h2>
              <p class="tempor_text">adipiscing elit, sed do eiusmod tempor </p>
              <div class="buy_bt_1"><a href="prod2">Buy Now</a></div>
            </div>
          </div>
          <div class="col">
            <div class="box_section">
              ...
              <h2 class="dolor_text_1">1 kg</h2>
              <p class="tempor_text">adipiscing elit, sed do eiusmod tempor </p>
              <div class="buy_bt_1"><a href="prod3">Buy Now</a></div>
            </div>
          </div>
          <div class="col">
            <div class="box_section">
              ...
              <h2 class="dolor_text_1">1 kg</h2>
              <p class="tempor_text">adipiscing elit, sed do eiusmod tempor </p>
              <div class="buy_bt_1"><a href="prod4">Buy Now</a></div>
            </div>
          </div>
          <div class="col">
            <div class="box_section">
              ...
              <h2 class="dolor_text_1">1 kg</h2>
              <p class="tempor_text">adipiscing elit, sed do eiusmod tempor </p>
              <div class="buy_bt_1"><a href="prod5">Buy Now</a></div>
            </div>
          </div>
        </div>
